...
/**
 * @author allenshen date: Jul 6, 2009 2:12:44 PM Copyright 2008 Sohu.com Inc.
 *         All Rights Reserved.
 */
...
//			Iterator<Serializable> iter = idObjMap.keySet().iterator(); // edit by songkun
		...
		try {
			...
			if (null == cache) {
				...
				if (count >= 0) {
					...
					cache.put(lsInfo.getListCntKey(), new Long(0));
