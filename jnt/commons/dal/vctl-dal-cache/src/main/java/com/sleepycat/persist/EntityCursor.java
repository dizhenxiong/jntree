 ...
 * }</pre>
 *
 * <p>The {@link Iterable} interface is also extended by {@link com.sleepycat.persist.EntityCursor}
 ...
 * cursor by calling {@link #next()} when {@link java.util.Iterator#hasNext} or {@link
 * java.util.Iterator#next} is called.  Because of this interaction, to keep things
