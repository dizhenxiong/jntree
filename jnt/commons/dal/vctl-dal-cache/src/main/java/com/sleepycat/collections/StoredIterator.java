 ...
 *
 * <p>While in general this class conforms to the {@link java.util.Iterator} interface,
 ...
 *
 * <p>This class implements the {@link java.util.Iterator} interface for all stored
 * iterators.  It also implements {@link java.util.ListIterator} because some list
 ...
 * <ul>
 * <li>{@link #close()}</li>
 * <li>{@link #close(java.util.Iterator)}</li>
 * <li>{@link #count()}</li>
...
public class StoredIterator<E>
     ...
     * com.sleepycat.collections.StoredIterator}.  If the given iterator is not a {@link com.sleepycat.collections.StoredIterator},
     ...
     * This method conforms to the {@link java.util.Iterator#hasNext} interface.
     *
     ...
     * This method conforms to the {@link java.util.ListIterator#hasPrevious} interface.
     *
     ...
     * This method conforms to the {@link java.util.Iterator#next} interface.
     *
    ...
    /**
     * Returns the next element in the iteration.
     * This method conforms to the {@link java.util.ListIterator#previous} interface.
     *
     ...
     * call to next.
     * This method conforms to the {@link java.util.ListIterator#nextIndex} interface
     ...
     * Returns the index of the element that would be returned by a subsequent
     * call to previous.
     * This method conforms to the {@link java.util.ListIterator#previousIndex}
     * interface.
     *
     ...
     * This method conforms to the {@link java.util.ListIterator#set} interface.
     *
     ...
     * operation).
     * This method conforms to the {@link java.util.ListIterator#remove} interface except
     ...
     * This method conforms to the {@link java.util.ListIterator#add} interface when
     ...
     * This method does not exist in the standard {@link java.util.Iterator} or {@link
     * java.util.ListIterator} interfaces.
     *
