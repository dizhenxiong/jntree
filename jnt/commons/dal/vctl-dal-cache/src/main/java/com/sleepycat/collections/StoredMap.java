...
public class StoredMap<K,V> extends StoredContainer
     ...
     * key.
     *
     * This method conforms to the {@link java.util.Map#get} interface.
     *
     * @throws RuntimeExceptionWrapper if a {@link
     * com.sleepycat.je.DatabaseException} is thrown.
     */
     ...
     * the key.  This method does not exist in the standard {@link java.util.Map}
     * interface.
     *
     ...
     * java.util.Map#remove} interface.
     *
     ...
     * java.util.concurrent.ConcurrentMap#putIfAbsent} interface.
     *
     * @throws RuntimeExceptionWrapper if a {@link
     * com.sleepycat.je.DatabaseException} is thrown.
     */
     ...
     * method conforms to the {@link java.util.concurrent.ConcurrentMap#remove(Object,Object)}
     * interface.
     *
     * @throws RuntimeExceptionWrapper if a {@link
     * com.sleepycat.je.DatabaseException} is thrown.
     ...
     * method conforms to the {@link java.util.concurrent.ConcurrentMap#replace(Object,Object)}
     * interface.
     *
     * @throws RuntimeExceptionWrapper if a {@link
     * com.sleepycat.je.DatabaseException} is thrown.
     ...
     * java.util.concurrent.ConcurrentMap#replace(Object,Object,Object)} interface.
     *
     * @throws RuntimeExceptionWrapper if a {@link
     * com.sleepycat.je.DatabaseException} is thrown.
     */
     ...
     * conforms to the {@link java.util.Map#containsKey} interface.
     *
     * @throws RuntimeExceptionWrapper if a {@link
     * com.sleepycat.je.DatabaseException} is thrown.
     */
     ...
     * the {@link java.util.Map#containsValue} interface.
     *
     * @throws RuntimeExceptionWrapper if a {@link
     * com.sleepycat.je.DatabaseException} is thrown.
     */
     ...
     * method conforms to the {@link java.util.Map#putAll} interface.
     *
     ...
     * method conforms to the {@link java.util.Map#keySet()} interface.
     *
     ...
     * java.util.SortedSet} is returned if the map supports key ranges.  The
     * returned collection will be read-only if the map is read-only.  This
     * method conforms to the {@link java.util.Map#entrySet()} interface.
     *
     * <p>Note that the return value is a StoredCollection and must be treated
     * as such; for example, its iterators must be explicitly closed.</p>
     *
     ...
     * map is read-only.  This method conforms to the {@link java.util.Map#values()}
     * interface.
     *
     * <p>Note that the return value is a StoredCollection and must be treated
     * as such; for example, its iterators must be explicitly closed.</p>
     ...
     * the standard {@link java.util.Map} interface.
     *
     ...
     * in the standard {@link java.util.Map} interface.
     *
     * <p>If no mapping for the given key is present, an empty collection is
     * returned.  If duplicates are not allowed, at most a single value will be
     * in the collection returned.  If duplicates are allowed, the returned
     ...
     * method conforms to the {@link java.util.Map#equals} interface.
     *
     * @throws RuntimeExceptionWrapper if a {@link
     * com.sleepycat.je.DatabaseException} is thrown.
     */
