 ...
 * {@link com.sleepycat.bind.tuple.SortedFloatBinding} are different and incompatible.  They are not
 * interchangeable once data has been stored.</li>
 * <li>An instance of {@link FloatBinding}, not {@link com.sleepycat.bind.tuple.SortedFloatBinding}, is
 * returned by {@link TupleBinding#getPrimitiveBinding} method.  Therefore, to
 * use {@link com.sleepycat.bind.tuple.SortedFloatBinding}, {@link TupleBinding#getPrimitiveBinding}
