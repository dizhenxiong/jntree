 ...
 *
 * <p>This class is used instead of an {@link java.io.ObjectOutputStream}, which it
 ...
 * com.sleepycat.bind.serial.SerialOutput} is used when an {@link java.io.ObjectOutputStream} is needed along
...
public class SerialOutput extends ObjectOutputStream {
     ...
     * {@link com.sleepycat.bind.serial.SerialOutput} always uses PROTOCOL_VERSION_2 serialization format
