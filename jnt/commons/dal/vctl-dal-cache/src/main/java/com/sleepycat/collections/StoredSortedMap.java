...
public class StoredSortedMap<K,V>
     ...
     * This method does not conform to the {@link java.util.SortedMap#comparator}
     * interface.
     *
     * @return null.
     */
     ...
     * This method conforms to the {@link java.util.SortedMap#firstKey} interface.
     *
     ...
     * This method conforms to the {@link java.util.SortedMap#lastKey} interface.
     *
     * @return the last key.
     *
     * @throws RuntimeExceptionWrapper if a {@link
     ...
     * This method conforms to the {@link java.util.SortedMap#headMap} interface.
     *
     ...
     * This method does not exist in the standard {@link java.util.SortedMap} interface.
     *
     * <p>Note that the return value is a StoredStoredMap and must be treated
     * as such; for example, its iterators must be explicitly closed.</p>
     *
     ...
     * This method conforms to the {@link java.util.SortedMap#tailMap} interface.
     *
     * <p>Note that the return value is a StoredStoredMap and must be treated
     * as such; for example, its iterators must be explicitly closed.</p>
     *
     ...
     * This method conforms to the {@link java.util.SortedMap#subMap} interface.
     *
     * <p>Note that the return value is a StoredStoredMap and must be treated
     * as such; for example, its iterators must be explicitly closed.</p>
     *
