...
public class TupleOutput extends FastOutputStream {
     ...
     * limited to those with a byte array ({@link java.math.BigInteger#toByteArray})
     ...
     * <li>Byte 2: The first byte of the {@link java.math.BigInteger#toByteArray} array,
     ...
     * java.math.BigInteger#toByteArray} array, written without modification.</li>
     * </ul>
     ...
     *
     * @see com.sleepycat.bind.tuple.TupleOutput#writeBigInteger
     */
